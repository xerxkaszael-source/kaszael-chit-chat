...
// For git-linked deploys (Netlify/GitHub Pages), commit the real anon key directly:
//   the build can't reach ~/.hermes/.env, so a placeholder would brick the live site.
// scripts/deploy.sh still re-injects from env when zip-dropping to Netlify (idempotent).
